    ...
    <div class="search-input">
      <div class="input-container">
        ...
        <input
              ...
              <select v-if="search_in === 'sp_srs'"  class="form-select " v-model="search_param" @change="updateSearchQuery(search_input, search_param)" >
              ...
              <select v-if="search_in === 'sp_all_srs'"  class="form-select " v-model="search_param" @change="updateSearchQuery(search_input, search_param)" >
